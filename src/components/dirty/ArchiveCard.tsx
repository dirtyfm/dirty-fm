...
export function ArchiveCard({
  ...
  return (
    <article
      className={cx(
        "group grid gap-4 border border-[rgba(183,178,168,0.24)] border-l-8 bg-dirty-purple/70 bg-[linear-gradient(135deg,rgba(78,107,74,0.22),transparent_55%)] p-5 shadow-signal",
    ...
    >
      ...
      {href ? (
        <Link
          className="font-utility text-sm font-black uppercase text-dirty-yellow no-underline group-hover:text-dirty-red"
          href={href}
        >
          {actionLabel}
        </Link>
